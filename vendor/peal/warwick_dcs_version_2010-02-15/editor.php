  ...
  <div class="playground" style="padding-left: 10pt; padding-top: 10pt;">
   <div style="border-bottom: 0px solid black;">
		...
		<div style="margin-top: -15pt;">
			<p>PEAL v0.5.5<br/>
			<p><a href="http://www.surveymonkey.com/s/LZBBQMV">Please answer a short survey about the usability of PEAL</a></p>
...
implementation (
	...
	<div id="wizard" class="dragable">
		...
		<form id="frmwizard" name="frmwizard" action="">
			...
			<div style="text-align: right; width: 300pt;"><input type="button" name="remove" value="- Remove Variable" onclick="removeVariableFromList();" /></div>
			<div style="text-align: right; width: 300pt; padding-top: 5pt;"><input type="button" value="OK" name="ok" onclick="okWizard();"/> <input type="button" value="Cancel" name="cancel" onClick="cancelWizard();"/></div>
		</form>
		</div>
	</div>
